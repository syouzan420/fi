...
initMsg="不思議なところ・・・。\nここは どこだらう・・・。\n＜キーボードなら hjklキーを。\nタッチなら 画面の端をタップすることで 動けさうです＞{e.bC.m1:s0C0:1:s0C1:1:s0C2:0:s0C3}{e.==.m1:s0c}{e.b9.m1:s090}{e.b8.m1:s080}{e.b3.m1:s030}{e.b2.m1:s020}{e.b1.jl3}{e.bA&s3.m1:s3A0}"
...
msgs=[("initMsg",initMsg),("s0C0",s0C0),("s0C1",s0C1),("s0C2",s0C2),("s0C3",s0C3),("s0c",s0c),("s0C4",s0C4),("s1",s1),("s1Q1",s1Q1),("s1Q2",s1Q2),("s1Q3",s1Q3),("s1C0",s1C0),("s1S0",s1S0),("s1S1",s1S1),("s1J0",s1J0),("s1J1",s1J1),("s1c",s1c),("s2",s2),("s2Q1",s2Q1),("s2Q2",s2Q2),("s2Q3",s2Q3),("s2Q4",s2Q4),("s2Q5",s2Q5),("s2P",s2P),("s2I",s2I),("s2H",s2H),("s2N",s2N),("s2Not",s2Not),("s2J0",s2J0),("s2B0",s2B0),("s2_1",s2_1),("s2_2",s2_2),("s2_3",s2_3),("s2c",s2c),("msgR",msgR),("msgW",msgW),("nubatama",nubatama),("s090",s090),("s080",s080),("s030",s030),("s020",s020),("s3A0",s3A0)]